...
namespace DAFFViz
{
	...
	public:
		...
		*/
		...
		// The following three functions' visibility changed to public. 
		// This may have undesirable side effects and is just a quick workaround to access them in apps/viewer/src/QDAFFVTKWidget.cpp
		// (by Simon of IIS)
