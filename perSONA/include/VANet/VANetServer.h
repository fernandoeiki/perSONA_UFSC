...
public:
	 ...
	 *
	 */
	virtual int Initialize( const std::string& sInterface, const int iServerPort = VANET_DEFAULT_PORT, const int iFreePortMin = 10000, const int iFreePortMax = 11000,
	                        const int iMaxNumClients = -1 ) = 0;
	...
	public:
		 ...
		 */
		inline CEvent( const int iInitType, const std::string& sClient ) : iType( iInitType ), sClient( sClient ) { };
	};
