...
VANet provides a transparent network communication of calls to the VA interface. It is useful to control a VA server remotely and is the standard way to communicate with
VA for inter-process methods and bindings for other scripting languages.
