	...
	namespace UrbanEngine
	{
		namespace MirrorImage
		{
			...
			private:
				...
				std::vector<std::string> m_vsBuildingNames;
			};
			...
			public:
				//---Constructor------------------------------------------------------------------------------------------------------
				CImageNode( const int iOrder, const int iMaxOrder, const ITAGeo::Urban::CModel& oUrbanModel, CImageNode* pParent_ = nullptr,
