...
#define VA_EXCEPT0( ERRRORCODE )                            \
	{                                                       \
		throw CVAException( ( CVAException::ERRRORCODE ) ); \
	}
#define VA_EXCEPT1( ERRRORMSG )                                         \
	{                                                                   \
		throw CVAException( CVAException::UNSPECIFIED, ( ERRRORMSG ) ); \
	}
#define VA_EXCEPT2( ERRORCODE, ERRRORMSG )                                \
	{                                                                     \
		throw CVAException( ( CVAException::ERRORCODE ), ( ERRRORMSG ) ); \
	}
#define VA_EXCEPT_NOT_IMPLEMENTED                                                   \
	{                                                                               \
		throw CVAException( ( CVAException::NOT_IMPLEMENTED ), "Not implemented" ); \
	}
#define VA_EXCEPT_NOT_IMPLEMENTED_NEXT_VERSION                                                                                            \
	{                                                                                                                                     \
		throw CVAException( ( CVAException::NOT_IMPLEMENTED ),                                                                            \
		                    "This new method has been introduced to the VA interface and will be implemented in the next core version" ); \
	}
#define VA_EXCEPT_NOT_IMPLEMENTED_FUTURE_VERSION                                                                                         \
	{                                                                                                                                    \
		throw CVAException( ( CVAException::NOT_IMPLEMENTED ),                                                                           \
		                    "This new method has been introduced to the VA interface for future use and is currently not implemented" ); \
	}
