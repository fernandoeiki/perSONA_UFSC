...
public:
	...
	static const int VA_AURAMODE_DEFAULT = VA_AURAMODE_DIRECT_SOUND | VA_AURAMODE_SOURCE_DIRECTIVITY | VA_AURAMODE_MEDIUM_ABSORPTION | VA_AURAMODE_DOPPLER |
	                                       VA_AURAMODE_SPREADING_LOSS | VA_AURAMODE_TRANSMISSION | VA_AURAMODE_ABSORPTION;

	//! All auralization modes (mask)
	static const int VA_AURAMODE_ALL = VA_AURAMODE_DIRECT_SOUND | VA_AURAMODE_EARLY_REFLECTIONS | VA_AURAMODE_DIFFUSE_DECAY | VA_AURAMODE_SOURCE_DIRECTIVITY |
	                                   VA_AURAMODE_MEDIUM_ABSORPTION | VA_AURAMODE_TEMP_VAR | VA_AURAMODE_SCATTERING | VA_AURAMODE_DIFFRACTION | VA_AURAMODE_NEARFIELD |
	                                   VA_AURAMODE_DOPPLER | VA_AURAMODE_SPREADING_LOSS | VA_AURAMODE_TRANSMISSION | VA_AURAMODE_ABSORPTION;
	 ...
	 * @param[in] iID	Sound source identifier
	 */
	inline void RemoveSoundSourceSignalSource( const int iID ) { SetSoundSourceSignalSource( iID, "" ); };
	...
	//! Sound receiver muted getter
	/**
	 * @param[in] iID Sound receiver identifier
	 * @return True, if muted
	 */
	virtual bool GetSoundReceiverMuted( const int iID ) const = 0;

	//! Sound receiver muted setter
	/**
	 * @param[in] iID Sound receiver identifier
	 * @param[in] bMuted Mutes sound receiver, if true
	 */
	virtual void SetSoundReceiverMuted( const int iID, const bool bMuted = true ) = 0;
