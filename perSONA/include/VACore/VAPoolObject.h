 ...
 */
class VACORE_API CVAPoolObject
    : public IVAUncopyable
    , public CVAReferenceableObject
{
public:
 ...
 */
template<class T>
class CVAPoolObjectDefaultFactory : public IVAPoolObjectFactory
{
public:
	//! Factory method
	/**
	 ...
	 * @return Pointer to the new pool object
	 */
	inline virtual CVAPoolObject* CreatePoolObject( ) { return new T; };
};
