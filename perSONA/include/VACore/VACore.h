...
VACore provides the entire functionality of real-time auralization and reproduction. It includes scene management and a lot of extra functionality to display and export
audio.

@section core_getting_started_sec Getting started

If you are a C++ developer and you want to integrate VA into your application, the first contact point should be the interface represented by the #IVAInterface class in
the VABase project. If you are planning to create a new binding for any other programming and/or scripting language, also have a look at VANet and the #IVANetClient
class.
