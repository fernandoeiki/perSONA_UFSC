...
set_target_properties(SampleRate::samplerate PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/samplerate/samplerate.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/samplerate.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS SampleRate::samplerate )
list(APPEND _IMPORT_CHECK_FILES_FOR_SampleRate::samplerate "${_IMPORT_PREFIX}/lib/samplerate/samplerate.lib" "${_IMPORT_PREFIX}/bin/samplerate.dll" )
